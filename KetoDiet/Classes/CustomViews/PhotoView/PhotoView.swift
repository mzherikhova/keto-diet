...
final class PhotoView: UIView {
    ...
    private func addImageView() {
        ...
        let constraints = NSLayoutConstraint.constraints(withNewVisualFormat: "H:|[imageView]|,V:|[imageView]|", dict: ["imageView": imageView])
    ...
    private func addLabel() {
        ...
        let constraints = NSLayoutConstraint.constraints(withNewVisualFormat: "H:|[label]|,V:[label]-16-|", dict: ["label": label])
        addConstraints(constraints)
    }
    ...
    private func addPlusView() {
        ...
        let constraints = NSLayoutConstraint.constraints(withNewVisualFormat: "H:|[plusView]|,V:|-(>=0)-[plusView(\(frame.height * 0.3))][label]", dict: ["label": label, "plusView": plusView])
        addConstraints(constraints)
    }
